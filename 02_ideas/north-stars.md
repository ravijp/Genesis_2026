...
**Provenance:** authored 2026-07-14 per Ravi's directive — "north-star ideas which are new and can change the problem space… CTO-level depth." Non-independent (author had full evidence-base exposure). **Red-teamed 2026-07-14** via two adversarial passes (freshness/narrowness + feasibility/demo) — verbatim verdicts and adjudication in `north-stars-redteam.md`; accepted revisions are folded in below and marked *[revised post-red-team]*. Outcome: N-001..N-006 stand (revised); **N-007 parked for competition** (retained as a Zenon-asset concept); N-006 is **conditional on GC track confirmation**. Every claim traces to `01_research/` or `00_sources/`. Format per `METHOD.md` Stage 1b. Pointer entries live in `backlog.md` (N-tier); scoring per RUBRIC — full frame for A1/A4, competition slice for G2/A3.
...
3. **Red-team outcome (2026-07-14, verdicts + adjudication in `north-stars-redteam.md`):** all seven concepts were adversarially attacked; revisions marked *[revised post-red-team]* inline. N-007 parked; N-006 conditional on GC track confirmation. Feasibility ranking (feasibility red-team pass): **N-003 > N-004 > N-005 > N-002 > N-001 > N-007 > N-006** — note the most buildable (N-003) and the freshest (N-002, the only unqualified freshness HOLDS) are different concepts; T6 scoring should weigh that trade explicitly.
