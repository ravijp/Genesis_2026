...
**Preparedness checklist (Ravi, 2026-07-15; clarified same day: this is the set of questions to have ready answers for, not a formal judge persona):** expect trivial-then-suddenly-hard questions regardless of the panel's background. Every finalist carries rehearsed answers to the standing checklist (METHOD.md Stage-3 card template): user story · run requirements · infrastructure · willingness-to-pay · scaling · vision realism · evals · guardrails · failure handling + logging · cost · latency · dollar impact — plus (post-T14 addendum) the **3-week-fit story** and the **1-year engagement arc**.
