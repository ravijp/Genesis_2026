...
| T4 | P1 | Haiku collation: gather all "Candidate use-case seeds" from `01_research/*.md` into `02_ideas/backlog.md` (verbatim, no invention) | CLAIMED (2026-07-14, Claude session — haiku agent running) |
